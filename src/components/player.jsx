...
import { useAddFavoriteTrackMutation, useDeleteFavoriteTrackMutation, useGetTrackByIdQuery } from '../redux/musicApi';
import { useDispatch, useSelector } from 'react-redux';
import { getCurrentTrack, getTrackId, play, playNextTrack, playPrevTrack, repeatTrack, shuffleTracks, sortTracks } from '../redux/slices/playerSlice';
    ...
    <div className={classNames(styles.bar__player, styles.player)}>
        ...
        <div className={styles.controls}>
            ...
            <div onClick={repeatSong} className={classNames(styles.btn_repeat, styles.btn_icon)}>
                {isRepeat ?
                    <svg className={styles.repeat_svg} width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div onClick={shuffleSong} className={classNames(styles.btn_shuffle, styles.btn_icon)}>
                {isShuffle ? <svg className={styles.shuffle_svg} width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    :
                <svg className={styles.shuffle_svg} width="19" height="18" viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={styles.track_play}>
            ...
            <div className={styles.like_dis}>
                <div onClick={addFavorite} className={classNames(styles.like, styles.btn_icon)}>
                    <svg  className={styles.dislike_svg}  width="16" height="14" viewBox="0 0 16 14" fill="none" 
                    xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.99997 2.25572H8.02154C8.95343 1.44175 11.4125 0.165765 13.6127 1.76734C16.9673 4.20921 13.902 9.5 8.02154 13H7.99997M8.00003 2.25572H7.97846C7.04657 1.44175 4.58746 0.165765 2.38727 1.76734C-0.967302 4.20921 2.09797 9.5 7.97846 13H8.00003" stroke="#696969"/>
                    </svg>
                </div>
                <div onClick={deleteFavorite} className={classNames(styles.dislike, styles.btn_icon)}>
                    <svg  className={styles.dislike_svg} width="16" height="15" viewBox="0 0 16 15" 
